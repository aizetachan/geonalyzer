...
const de: Dictionary = {
  ...
  pillar: {
    seo: 'SEO',
    geo: 'GEO',
    seoDesc: 'Was Google sieht — es führt JavaScript aus.',
    geoDesc: 'Was KI-Maschinen sehen — rohes HTML, ohne JavaScript.',
  },
  ...
  report: {
    ...
    seoScore: 'SEO-Punktzahl',
    geoScore: 'GEO-Punktzahl',
  ...
  evidence: {
    https: { protocol: 'Protokoll' },
    httpStatus: { code: 'Statuscode' },
    htmlLang: { value: 'Deklarierte Sprache' },
    viewport: { content: 'Viewport-Inhalt' },
    canonical: { url: 'Canonical-URL' },
    metaRobots: { content: 'Meta-Robots' },
    robots: { url: 'robots.txt-URL' },
    sitemap: { url: 'sitemap.xml-URL' },
    urlClean: { url: 'URL-Pfad' },
    title: { text: 'Title-Text', length: 'Länge (Zeichen)' },
    metaDescription: { text: 'Beschreibungstext', length: 'Länge (Zeichen)' },
    h1: { count: 'H1-Anzahl', text: 'Erste H1' },
    headings: { count: 'Überschriften', outline: 'Gliederung' },
    wordCount: { value: 'Wörter' },
    textHtmlRatio: { value: 'Text/HTML-Verhältnis' },
    imgAlt: { coverage: 'Bilder mit alt', missingCount: 'Bilder ohne alt', samples: 'Beispiele' },
    openGraph: { present: 'Vorhandene Tags', missing: 'Fehlende Tags' },
    twitterCards: { card: 'Card-Typ' },
    internalLinks: { count: 'Interne Links', samples: 'Beispiele' },
    jsonld: { blocks: 'JSON-LD-Blöcke' },
    schemaTypes: { list: 'Erkannte Typen' },
    orgSameas: { profiles: 'Verknüpfte Profile' },
    authorProfile: { name: 'Autor' },
    syntaxValid: { invalid: 'Blöcke mit Fehlern' },
    bots: { blocked: 'Blockiert', allowed: 'Erlaubt', trainingBlocked: 'Blockierte Trainings-Bots' },
    llms: { url: 'llms.txt-URL', firstHeading: 'Erste Überschrift' },
    bluf: { opening: 'Einleitung' },
    dataDensity: { figures: 'Zahlen', percents: 'Prozentwerte' },
    promo: { hits: 'Werbliche Formulierungen' },
    qa: { count: 'Frage-Überschriften', samples: 'Beispiele' },
    tables: { count: 'Tabellen' },
    transcript: { mediaCount: 'Medienelemente' },
    semantic: { semanticCount: 'Semantische Elemente', divCount: 'Divs' },
    js: { words: 'Wörter im HTML', scripts: 'Externe Skripte' },
  },
