...
const it: Dictionary = {
  ...
  pillar: {
    seo: 'SEO',
    geo: 'GEO',
    seoDesc: 'Ciò che vede Google — esegue JavaScript.',
    geoDesc: 'Ciò che vedono i motori IA — HTML grezzo, senza JavaScript.',
  },
  ...
  report: {
    title: 'Analisi SEO + GEO',
    intro:
      "Questo è un audit automatico SEO + GEO (ottimizzazione per i motori generativi). Il GEO misura quanto bene la pagina può essere scoperta e citata dai motori di risposta IA come ChatGPT, Claude e Perplexity. Sulla base dei risultati seguenti, fornisci un piano d'azione concreto e prioritizzato per migliorare il SEO e il GEO di questa pagina.",
    url: 'URL',
    analyzed: 'Analizzato',
    overall: 'Punteggio globale',
    seoScore: 'Punteggio SEO',
    geoScore: 'Punteggio GEO',
    scores: 'Punteggi per categoria',
    findings: 'Risultati',
    priority: 'Raccomandazioni prioritarie (per impatto)',
    finding: 'Risultato',
    fix: 'Come correggere',
    performanceNote: 'non misurato (richiede un backend)',
    copy: "Copia il report per l'IA",
    download: 'Scarica',
    copied: 'Copiato!',
  },
  ...
  warnings: {
    ...
    unreliable:
      'La pagina è stata recuperata solo tramite un proxy pubblico, quindi alcuni risultati potrebbero essere meno affidabili.',
  },
  ...
  msg: {
    tech: {
      ...
      robotsTxt: {
        ...
        spaFallback:
          "/robots.txt ha restituito la pagina HTML dell'app (catch-all dello SPA); non esiste un vero robots.txt.",
      },
      sitemap: {
        missingRef:
    ...
    geo: {
      ...
      llmsTxt: {
        ...
        spaFallback:
          "/llms.txt ha restituito la pagina HTML dell'app (catch-all dello SPA); non esiste un vero llms.txt.",
      },
      bluf: {
        none:
  ...
  evidence: {
    https: { protocol: 'Protocollo' },
    httpStatus: { code: 'Codice di stato' },
    htmlLang: { value: 'Lingua dichiarata' },
    viewport: { content: 'Contenuto del viewport' },
    canonical: { url: 'URL canonical' },
    metaRobots: { content: 'Meta robots' },
    robots: { url: 'URL di robots.txt' },
    sitemap: { url: 'URL di sitemap.xml' },
    urlClean: { url: "Percorso dell'URL" },
    title: { text: 'Testo del title', length: 'Lunghezza (caratteri)' },
    metaDescription: { text: 'Testo della descrizione', length: 'Lunghezza (caratteri)' },
    h1: { count: 'Numero di H1', text: 'Primo H1' },
    headings: { count: 'Intestazioni', outline: 'Struttura' },
    wordCount: { value: 'Parole' },
    textHtmlRatio: { value: 'Rapporto testo/HTML' },
    imgAlt: { coverage: 'Immagini con alt', missingCount: 'Immagini senza alt', samples: 'Esempi' },
    openGraph: { present: 'Tag presenti', missing: 'Tag mancanti' },
    twitterCards: { card: 'Tipo di card' },
    internalLinks: { count: 'Link interni', samples: 'Esempi' },
    jsonld: { blocks: 'Blocchi JSON-LD' },
    schemaTypes: { list: 'Tipi rilevati' },
    orgSameas: { profiles: 'Profili collegati' },
    authorProfile: { name: 'Autore' },
    syntaxValid: { invalid: 'Blocchi con errori' },
    bots: { blocked: 'Bloccati', allowed: 'Consentiti', trainingBlocked: 'Bot di addestramento bloccati' },
    llms: { url: 'URL di llms.txt', firstHeading: 'Prima intestazione' },
    bluf: { opening: 'Apertura' },
    dataDensity: { figures: 'Cifre', percents: 'Percentuali' },
    promo: { hits: 'Frasi promozionali' },
    qa: { count: 'Intestazioni con domanda', samples: 'Esempi' },
    tables: { count: 'Tabelle' },
    transcript: { mediaCount: 'Elementi multimediali' },
    semantic: { semanticCount: 'Elementi semantici', divCount: 'Div' },
    js: { words: "Parole nell'HTML", scripts: 'Script esterni' },
  },
